...
enum crn_file_type {
  ...
  cCRNFileTypeForceDWORD = 0x7FFFFFFF
};
...
enum crn_comp_flags {
  ...
  cCRNCompFlagForceDWORD = 0x7FFFFFFF
};
...
enum crn_dxt_quality {
  ...
  cCRNDXTQualityForceDWORD = 0x7FFFFFFF
};
...
enum crn_dxt_compressor_type {
  ...
  cCRNDXTCompressorForceDWORD = 0x7FFFFFFF
};
...
enum crn_mip_filter {
  ...
  cCRNMipFilterForceDWORD = 0x7FFFFFFF
};
...
DLL_EXPORT void DLL_API crn_free_block(void* pBlock);
...
DLL_EXPORT void* DLL_API crn_compress(const crn_comp_params& comp_params, crn_uint32& compressed_size, crn_uint32* pActual_quality_level = NULL, float* pActual_bitrate = NULL);
...
DLL_EXPORT void* DLL_API crn_compress_mip(const crn_comp_params& comp_params, const crn_mipmap_params& mip_params, crn_uint32& compressed_size, crn_uint32* pActual_quality_level = NULL, float* pActual_bitrate = NULL);
...
DLL_EXPORT void* DLL_API crn_decompress_crn_to_dds(const void* pCRN_file_data, crn_uint32& file_size);
