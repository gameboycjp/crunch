...
struct STRUCT_PACK crn_file_info {
...
struct STRUCT_PACK crn_texture_info {
...
struct STRUCT_PACK crn_level_info {
...
DLL_EXPORT bool DLL_API crnd_get_texture_info(const void* pData, uint32 data_size, crn_texture_info* pTexture_info);
...
DLL_EXPORT bool DLL_API crnd_get_level_info(const void* pData, uint32 data_size, uint32 level_index, crn_level_info* pLevel_info);
...
DLL_EXPORT bool DLL_API crnd_unpack_level_segmented(
    crnd_unpack_context pContext,
